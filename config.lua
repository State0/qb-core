...
QBConfig.Player = {}
QBConfig.Player.MaxWeight = 60000 -- Max weight a player can carry (currently 120kg, written in grams)
...
QBConfig.Server.Discord = "https://discord.gg/auYsx7Gh" -- Discord invite link
